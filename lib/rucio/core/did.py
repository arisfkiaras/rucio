...
#     :param scope: the scope of did
#     :param name: the name of the did
#     :returns: List of JSON metadata for did.
#     """
#     return did_meta_plugins.get_did_meta(scope, name, filter="JSON", session=session)
...
#         did_meta_plugins.set_did_meta(scope, name, key=k, value=v, session=session)
...
#     :param key: the key to be deleted
#     """
#     did_meta_plugins.delete_did_meta(scope, name, key, session=session)
...
#     :param meta: the metadata to be added or updated
#     """
#     return did_meta_plugins.list_dids(scope, filters=select, session=session)
