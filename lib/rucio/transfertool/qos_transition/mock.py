from rucio.transfertool.qos_transition.qostransitiontool import QoSTransitionTool
import uuid


class MockQoSTransitionTool(QoSTransitionTool):
    """
    ...
    def __init__(self, external_host, token=None):
        super(MockQoSTransitionTool, self).__init__(external_host)
